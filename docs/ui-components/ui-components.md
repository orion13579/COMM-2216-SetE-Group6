...
By following this section, you would be able to add other email addresses for different purposes, change your _Primary Email Address_ to another email address, choose your _Backup Email Address_, and switch your _Primary Email Address_ between private (default) and public mode if needed.
